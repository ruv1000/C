...
namespace Calcul
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void provdisplayNumber()
        {
            ...
            if ((((textBox1.Text[0].ToString() == "0") || (textBox1.Text[0].ToString() == "-" && textBox1.Text[1].ToString() == "0")) && _digits.Contains(",")))
            {
                textBox1.Text = "0";
            ...
            {
                textBox1.Text = "";
                // Проход по стеку разрядов и формирование
        ...
        {
            if (number.ToString() == "бесконечность")
            {
        ...
        private void ShiftMemory()
        {
            ...
            {
                Z = 0;
                MessageBox.Show("Занести невезможно");
            }
        }
